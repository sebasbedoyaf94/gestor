...
class Checklist extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('check_id, check_proy_id, check_url_pruebas, check_ruta_doc_funcional, check_ruta_doc_tecnica, check_usuario_pruebas, check_contrasena_pruebas, check_creadopor, check_fechacreado, check_modificadopor, check_fechamodificado', 'required'),
			array('check_id, check_proy_id, check_creadopor, check_modificadopor', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			'check_id' => 'Check',
			'check_proy_id' => 'Check Proy',
			'check_url_pruebas' => 'Check Url Pruebas',
			'check_ruta_doc_funcional' => 'Check Ruta Doc Funcional',
			'check_ruta_doc_tecnica' => 'Check Ruta Doc Tecnica',
			'check_observaciones' => 'Check Observaciones',
			'check_usuario_pruebas' => 'Check Usuario Pruebas',
			'check_contrasena_pruebas' => 'Check Contrasena Pruebas',
			'check_creadopor' => 'Check Creadopor',
			'check_fechacreado' => 'Check Fechacreado',
			'check_modificadopor' => 'Check Modificadopor',
			'check_fechamodificado' => 'Check Fechamodificado',
		);
	}
