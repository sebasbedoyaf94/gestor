...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6">
        <?php echo $form->dropDownListGroup($model_proyectos, 'proy_id',
            array(
...
<?php 
echo $form->labelEx($model, 'carga_nombre_archivo');
echo $form->fileField($model, 'carga_nombre_archivo');
echo $form->error($model, 'carga_nombre_archivo');
?>
