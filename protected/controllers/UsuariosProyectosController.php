...
class UsuariosProyectosController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('UsuariosProyectos');
	...
	{
		$model=new UsuariosProyectos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UsuariosProyectos']))
			$model->attributes=$_GET['UsuariosProyectos'];
	 ...
	 * @return UsuariosProyectos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=UsuariosProyectos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UsuariosProyectos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='usuarios-proyectos-form')
		{
