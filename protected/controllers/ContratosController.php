...
class ContratosController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',
				...
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Contratos']) || !empty(Yii::app()->session['permisosRol']['Contratos']['Consultas'])",
			),
			array('allow',
				'actions'=>array('create'),
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Contratos']['Crear'])",
			),
			array('allow',
				'actions'=>array('update'),
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Contratos']['Modificar'])",
			),
			array('deny',
			'users'=>array('*'),
			),
	...
	*/
	public function actionCreate()
	{
		...
		{
			$_POST['Contratos']['cont_creadopor'] = Yii::app()->session['login_usuarioid'];
			$_POST['Contratos']['cont_modificadopor'] = Yii::app()->session['login_usuarioid'];
