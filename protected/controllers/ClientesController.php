	...
	public function accessRules()
	{
		return array(
			array('allow',
				...
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Clientes']) || !empty(Yii::app()->session['permisosRol']['Clientes']['Consultas'])",
			),
			array('allow',
				'actions'=>array('create'),
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Clientes']['Crear'])",
			),
			array('allow',
				'actions'=>array('update'),
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Clientes']['Modificar'])",
			),
