...
class NovedadesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',
				...
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Novedades']) || !empty(Yii::app()->session['permisosRol']['Novedades']['Consultas'])",
			),
			array('allow',
				'actions'=>array('create'),
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Novedades']['Crear'])",
			),
			array('allow',
				'actions'=>array('update'),
				'users'=>array('@'),
				'expression'=>"!empty(Yii::app()->session['permisosRol']['Novedades']['Modificar'])",
			),
			array('deny',
			'users'=>array('*'),
			),
	...
	*/
	public function actionCreate()
	{
		...
		{
			$_POST['Novedades']['nov_creadopor'] = Yii::app()->session['login_usuarioid'];
			$_POST['Novedades']['nov_modificadopor'] = Yii::app()->session['login_usuarioid'];
